...
{isOpen && (
  ...
  ></div>
        ...
        {/* Sidebar */}
        <aside
        className={`bg-white/70 backdrop-blur-md shadow-[4px_0_12px_rgba(0,0,0,0.08)] z-50 lg:hidden fixed top-0 left-0 h-full w-90  dark:bg-gray-900 transform transition-transform duration-800 ${
