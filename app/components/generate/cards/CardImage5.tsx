  ...
  return (
    ...
    <path d="M6.42188 16.1118C6.42188 16.1118 7.91228 17.3606 12.0006 17.3606C16.0889 17.3606 17.5793 16.1118 17.5793 16.1118" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 dark:hover:text-zinc-400 dark:active:text-zinc-400 cursor-pointer">Add objects, change style, or expand photos and generations.</p>
      </div>
