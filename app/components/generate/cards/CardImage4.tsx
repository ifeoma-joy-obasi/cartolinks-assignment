  ...
  return (
    <div className="w-full flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 dark:hover:text-zinc-400 dark:active:text-zinc-400 cursor-pointer">Upscale and enhance images and videos up to 22k.</p>
      </div>
